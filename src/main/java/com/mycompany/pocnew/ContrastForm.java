...
public class ContrastForm extends javax.swing.JFrame {

    POC parent = null;
    
    public ContrastForm(POC parent) {
    ...
    void processImage(BufferedImage src, BufferedImage dst, int db)
    {
        ...
        for (int y = 0; y < src.getHeight(); ++y)
        {
            ...
            {
                dp[i] = ImageAlgorithms.changeContrast(sp[i], db);
    ...
    private void sliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderStateChanged
        ...
        jLabel1.setText(Integer.toString(slider.getValue()));
        try
        {
